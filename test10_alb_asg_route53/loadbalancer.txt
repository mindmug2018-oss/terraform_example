# terraform_example/test10_alb_asg_route53/loadbalancer.tf
...
resource "aws_lb_listener" "https" {
  ...
  # 프로젝트 폴더 안에 route53.tf 가 포함되어 있는 경우 직접 발급 받을 인증서의 arn
  # certificate_arn   = aws_acm_certificate_validation.cert.certificate_arn
 
  # 여기에서는 route53.tf 실행하지 않고 미리 발급 받은 인증서의 arn 을 사용한다
